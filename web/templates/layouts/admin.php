    ...
    <aside class="w-64 flex-shrink-0 flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 h-screen sticky top-0 overflow-y-auto">
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5">
            ...
            $navItems = [
                ...
                'divider',
                ['href' => '/admin/targets', 'label' => 'Target Builder', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4', 'tip' => 'Build AND/OR target expressions, save presets, preview recipients, copy API payload'],
                ...
                'divider',
                ['href' => '/profile', 'label' => 'My Profile', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'tip' => 'Email, phone, password, and notification preferences'],
            ];
            ...
            foreach ($navItems as $item):
                ...
                $isActive = $currentPath === $item['href']
                    ...
                    || ($item['href'] === '/admin/targets' && $currentPath === '/admin/test-send');
        ...
        <div class="border-t border-gray-100 dark:border-gray-800 p-3 space-y-1">
            ...
            <div class="flex items-center gap-3 px-3 py-2 rounded-lg">
                ...
                <a href="/profile" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors" title="My profile">
