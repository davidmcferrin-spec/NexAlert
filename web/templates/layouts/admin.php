    ...
    <aside class="w-64 flex-shrink-0 flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 h-screen sticky top-0 overflow-y-auto">
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5">
            ...
            $navItems = [
                ...
                ['href' => '/admin/alerts', 'label' => 'Send Alert', 'icon' => 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z', 'highlight' => true],
